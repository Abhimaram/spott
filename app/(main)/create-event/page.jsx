    ...
    <div className="flex gap-3">
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button
            type="button"
            className="flex items-center justify-between px-4 py-3 rounded-lg  text-white w-full"
          >
            {startDate ? format(startDate, "MMMM do, yyyy") : "Pick date"}
            <CalendarIcon className="w-4 h-4 opacity-80 ml-3" />
          </button>
        </PopoverTrigger>
...
/>
      ...
      <div className="relative">
        <Input
          type="time"
          {...register("startTime")}
          className=" text-white border-none rounded-lg px-4 py-3 pr-10"
        />
      </div>
    </div>
  </div>
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button
            ...
            className="flex items-center justify-between px-4 py-3 rounded-lg text-white w-full"
          >
            {endDate ? format(endDate, "MMMM do, yyyy") : "Pick date"}
            <CalendarIcon className="w-4 h-4 opacity-80 ml-3" />
          </button>
        </PopoverTrigger>
        <PopoverContent className="p-0">
