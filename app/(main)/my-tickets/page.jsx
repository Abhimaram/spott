  ...
  return (
    <div className="min-h-screen pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Empty State */}
        {upcomingRegistrations?.length === 0 && PastTickets?.length === 0 && (
       <Card className="p-18 text-center bg-[#0f0f0f] border border-white/10 text-white shadow-xl">
...
<div className="bg-zinc-800/80 border border-white/10 p-4 rounded-lg space-y-2 text-sm text-white">
