      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="space-y-8">
            {/* Description */}
           <Card
           className="pt-0 border-white/10 shadow-xl backdrop-blur-xl"
           style={{
            backgroundColor: darkenColor(event.themeColor || "#7c2d12", 0.15),
            }}
            >
            ...
            {/* Location Details */}
           <Card
            className="pt-0 border-white/10 shadow-xl backdrop-blur-xl text-white"
           style={{
            backgroundColor: darkenColor(event.themeColor || "#7c2d12", 0.15),
            }}
         >
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-3">
                  ...
                  {event.venue && (
                   <Button
                   asChild
                  className="gap-2 bg-white text-black hover:bg-white/90 border-0"
                  >
                  <a
                  href={event.venue}
                  target="_blank"
...
">
          ...
          <Card
           className="overflow-hidden py-0 border-white/10 shadow-xl backdrop-blur-xl"
           style={{
            backgroundColor: darkenColor(event.themeColor || "#7c2d12", 0.15),
         }}
          >
              ...
              Price
               ...
               Pay at event offline
                ...
                <Button
                  variant="outline"
                  className="w-full gap-2 bg-white/90 hover:bg-white text-black border-0"
                  onClick={handleShare}
                >
